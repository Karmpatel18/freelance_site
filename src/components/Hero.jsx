    ...
    return (
        <div className='flex w-full max-w-[1200px] mt-[72px] flex-col sm:px-[240px] py-4 items-center'>
            <div className="flex flex-col items-center py-8">
                ...
                <div className='flex text-center leading-5 text-[20px] tracking-tight text-neutral-400 font-normal mt-2'>AI-powered startup studio helping founders launch<br/>
